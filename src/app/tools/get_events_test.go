...
func TestNewGetEventsTool_Success(t *testing.T) {
	...
	const responseJSON = `[{"id":1,"category":"WORKOUT","name":"Easy Run","start_date_local":"2024-01-15"}]`
	...
	registration := NewGetEventsTool(c)
...
func TestNewGetEventsTool_Validation(t *testing.T) {
	t.Parallel()
...
func TestNewGetEventsTool_APIError(t *testing.T) {
	t.Parallel()
